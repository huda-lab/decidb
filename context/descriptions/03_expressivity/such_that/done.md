...
- **Subquery handling**: `src/planner/expression_binder/decide_binder.cpp`
  ...
  - Correlated subquery RHS validation at execution: `src/decidb/utility/ilp_model_builder.cpp`, `SolverModel::Build()` — checks that aggregate constraint RHS is scalar
