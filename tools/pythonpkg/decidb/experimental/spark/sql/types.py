...
import decidb
from decidb.typing import DuckDBPyType
...
class DecimalType(FractionalType):
    ...
    def __init__(self, precision: int = 10, scale: int = 0):
        super().__init__(decidb.decimal_type(precision, scale))
...
class ArrayType(DataType):
    ...
    def __init__(self, elementType: DataType, containsNull: bool = True):
        super().__init__(decidb.list_type(elementType.duckdb_type))
...
class MapType(DataType):
    ...
    def __init__(self, keyType: DataType, valueType: DataType, valueContainsNull: bool = True):
        super().__init__(decidb.map_type(keyType.duckdb_type, valueType.duckdb_type))
...
class StructType(DataType):
    ...
    def _update_internal_duckdb_type(self):
        self.duckdb_type = decidb.struct_type(dict(zip(self.names, [x.duckdb_type for x in self.fields])))
    ...
    def __init__(self, fields: Optional[List[StructField]] = None):
        ...
        super().__init__(decidb.struct_type(dict(zip(self.names, [x.duckdb_type for x in self.fields]))))
