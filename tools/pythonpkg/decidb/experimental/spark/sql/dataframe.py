...
import decidb
from decidb import ColumnExpression, Expression, StarExpression
...
class DataFrame:
    def __init__(self, relation: decidb.DuckDBPyRelation, session: "SparkSession"):
    ...
    def schema(self) -> StructType:
        """Returns the schema of this :class:`DataFrame` as a :class:`decidb.experimental.spark.sql.types.StructType`.
    ...
    def __getitem__(
        ...
        if isinstance(item, str):
            return Column(decidb.ColumnExpression(self.relation.alias, item))
    ...
    def __getattr__(self, name: str) -> Column:
        ...
        return Column(decidb.ColumnExpression(self.relation.alias, name))
