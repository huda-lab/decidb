...
import decidb
from decidb import DuckDBPyConnection

from decidb.experimental.spark.exception import ContributionsAcceptedError
from decidb.experimental.spark.conf import SparkConf


class SparkContext:
    def __init__(self, master: str):
        self._connection = decidb.connect(':memory:')
